		...
		dark:focus-visible:ring-[#FF2D20]">
            <div class="pt-3 sm:pt-5 w-full">
                ...
                <div class="w-full mt-4">
                    ...
                    @empty
                        <h2 class="mt-1 text-center text-xl font-semibold text-black dark:text-white"> Não há respostas
                            cadastradas</h2>
                    @endforelse
                </div>
                    ...
                    <div class="w-full mt-4">
                        ...
                        <form action="{{ route('forum.reply') }}" method="POST">
                            ...
                            <textarea name="text" id="" rows="10"
                                class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ @old('text') }}</textarea>
